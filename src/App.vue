                ...
                <div 
                    ...
                    <div class="item-details-with-actions">
                        <div class="item-details">
                            ...
                            <p class="in-stock-status" v-if="item.status"> <i class="fa-solid fa-check"></i> In stock</p>
...
function removeItem(id) {
  //step 1: filter out the item with the given id
  let index = shoppingCartItems.value.findIndex((item) => {
    return item.id == id
  })
  //step 2: remove the item from the shopping cart
